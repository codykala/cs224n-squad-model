...
tf.app.flags.DEFINE_string("optimizer", "adam", "The optimizer used to train the model.  Needs to be one of: adam / gd / adadelta")
...
# Flags for adding layers to the model
tf.app.flags.DEFINE_string("model", "bidaf", "Specify which model layer to use.  Must be one of: bidaf / coattn / baseline")
